...
fig.tight_layout()
fig.savefig(os.path.join(PLOT_PATH,'microbe-walls-shannon.png'),dpi=500)
...
axes[3].set_ylim(0,lim[1])
fig.tight_layout()
fig.savefig(os.path.join(PLOT_PATH,'microbe-walls-on-virus-shannon.png'),dpi=500)
...
axes[3].set_ylim(0,lim[1])
fig.tight_layout()
fig.savefig(os.path.join(PLOT_PATH,'microbe-peaks-on-virus-shannon.png'),dpi=500)
