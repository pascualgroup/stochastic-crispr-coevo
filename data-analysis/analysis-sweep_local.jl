...
ROOT_PATH = joinpath("/scratch/cgsb/pascual/armun/crispr/vary-q-mu/sweep-7-2-2022_50reps/data-analysis")
# dbSimPath = joinpath(SCRIPT_PATH, "..", "simulation", "sweep_db.sqlite")
dbSimPath = joinpath("/Users/armun/Dropbox/Current/Projects/microbe-virus-crispr/stochastic-crispr/original/simulation/sweep_db.sqlite")
