...
babundthreshold  = 0 # this is %/100 of total population size
vabundthreshold  = .05 # this is %/100 of total population size
stacked = True
overlay = True
sSpacing = 8
vSpacing = 8
...
DBPROB_PATH = os.path.join(SCRIPT_PATH,'..','generated-data','isolates',run,'emergence-lambert-root_output.sqlite') # cluster
DBMATCH_PATH = os.path.join(SCRIPT_PATH,'..','generated-data','isolates',run,'matches_output.sqlite') # cluster
DBMATCHc_PATH = os.path.join(SCRIPT_PATH,'..','generated-data','isolates','comboID66','matchesC66.sqlite') # local
DBTREE_PATH = os.path.join(SCRIPT_PATH,'..','generated-data','isolates',run,'trees_output.sqlite') # cluster
DBTRI_PATH = os.path.join(SCRIPT_PATH,'..','generated-data','isolates',run,'tripartite-networks_output.sqlite') # cluster
...
if sys.argv[2] == 'host-strain-collapses':
...
if sys.argv[2] == 'abundances':
    ...
    microbe_stacked.plot.area(ax = ax,stacked=True,legend=False, linewidth=0,color=bSpeciesColorDict)
    microbe_stacked.plot(stacked=True, ax=ax, legend=False, color='black',linewidth=.1)
    ...
    plt.close(fig)
    fig, ax = plt.subplots(1)
    virus_stacked.plot.area(ax = ax,stacked=True,legend=False, linewidth=0,color=vSpeciesColorDict)
    virus_stacked.plot(stacked=True, ax=ax, legend=False, color='black',linewidth=.1)
    ...
    microbe_stacked.plot.area(ax = axes[0],stacked=True,legend=False, linewidth=0,color=bSpeciesColorDict)
    # microbe_stacked.plot(stacked=True, ax=axes[0], legend=False, color='white',linewidth=.01)
    virus_stacked.plot.area(ax = axes[1],stacked=True,legend=False, linewidth=0,color=vSpeciesColorDict)
    # virus_stacked.plot(stacked=True, ax=axes[1], legend=False, color='white',linewidth=.01)
...
if sys.argv[2] == 'viralheatmap':
    ...
    microbe_stacked.plot.area(ax=axes[0], stacked=True, legend=False,
                            linewidth=1.5, color=bSpeciesColorDict)
    axes[0].set_ylabel(ylabel='Host\nAbundances',
    ...
    axes[2].margins(y=0)
    fig.tight_layout()
    fig.savefig(os.path.join(PLOT_PATH,'viral-heat-map.pdf'),dpi=resolve)
    plt.close('all')
    ########
...
if sys.argv[2] == 'protospacer-div':
    ...
    microbe_stacked.plot.area(ax=axes[0], stacked=True, legend=False,
                        linewidth=0, cmap='Purples', alpha = 0.25)
    axes[1].plot(virus_total['t'], virus_total['Viral Abundance'],
                linewidth=0, color='grey')
    axes[1].fill_between(
        virus_total['t'], virus_total['Viral Abundance'], color='grey', alpha=0.6)
...
if sys.argv[2] == 'escapeheatmap':
    ...
    ax.zaxis.set_pane_color(cmap(0))
    ...
    ax.set_zlabel(zlabel=''.join(['Single-match\nShannon Diversity\n',
                                    r'for Viral Strain $i$', r'($D_i$)']), labelpad=30, fontsize=10, rotation=0)
    ax.set_box_aspect((1/2+np.sqrt(5)/2, 1, 1))
    # ax.view_init(elev=25, azim=135)
    ax.view_init(elev=20, azim=118)
    fig.savefig(os.path.join(PLOT_PATH, '3D-escape-diversity1.pdf'), dpi=resolve)
    plt.close('all')
    ###
    left = 16
    right = 200
    ...
    ax.set_box_aspect((1/2+np.sqrt(5)/2, 1, 1))
    ax.view_init(elev=20, azim=118)
    fig.savefig(os.path.join(PLOT_PATH, '3D-escape-diversity2.pdf'), dpi=resolve)
    plt.close('all')
    # color bar
    ...
    fig.savefig(os.path.join(PLOT_PATH, 'escape-diversity-colorbar.pdf'), dpi=resolve)
    plt.close('all')
...
if sys.argv[2] == 'diversity':
    ...
    axes = [ax[0], ax[0].twinx(), ax[0].twinx(), ax[4], ax[4].twinx(), 
            ...
            ax[6], ax[6].twinx()]
    microbe_stacked = bAbunds.pivot(index='t',columns='tree_bstrain_id',values='abundance')
    microbe_stacked.plot.area(ax = axes[0],stacked=True,legend=False, linewidth=0,color=bSpeciesColorDict,alpha=0.25)
    microbe_stacked.plot(stacked=True, ax=axes[0], legend=False, color='white',linewidth=.1)
    axes[0].set_yticklabels([])
    axes[0].set_yticks([])
    axes[0].margins(x=0)
    microbe_stacked.plot.area(ax = axes[3],stacked=True,legend=False, linewidth=0,color=bSpeciesColorDict,alpha=0.25)
    microbe_stacked.plot(stacked=True, ax=axes[3], legend=False, color='white',linewidth=.1)
    ...
    microbe_stacked.plot.area(ax = axes[6],stacked=True,legend=False, linewidth=0,color=bSpeciesColorDict,alpha=0.25)
    microbe_stacked.plot(stacked=True, ax=axes[6], legend=False, color='white',linewidth=.1)
    ...
    microbe_stacked.plot.area(ax = axes[8],stacked=True,legend=False, linewidth=0,color=bSpeciesColorDict,alpha=0.25)
    microbe_stacked.plot(stacked=True, ax=axes[8], legend=False, color='white',linewidth=.1)
    ...
    microbe_stacked.plot.area(ax = axes[10],stacked=True,legend=False, linewidth=0,color=bSpeciesColorDict,alpha=0.25)
    microbe_stacked.plot(stacked=True, ax=axes[10], legend=False, color='white',linewidth=.1)
    ...
    microbe_stacked.plot.area(ax = axes[12],stacked=True,legend=False, linewidth=0,color=bSpeciesColorDict,alpha=0.25)
    microbe_stacked.plot(stacked=True, ax=axes[12], legend=False, color='white',linewidth=.1)
    ...
    microbe_stacked.plot.area(ax = axes[14],stacked=True,legend=False, linewidth=0,color=bSpeciesColorDict,alpha=0.25)
    microbe_stacked.plot(stacked=True, ax=axes[14], legend=False, color='white',linewidth=.1)
...
if sys.argv[2] == 'R':
    ...
    microbe_stacked.plot.area(ax = axes[0],stacked=True,legend=False, linewidth=0,cmap='Purples',alpha=0.25)
    # microbe_stacked.plot(stacked=True, ax=axes[0], legend=False, color='white',linewidth=)
    ...
    axes[2].tick_params(axis='y', labelsize=20)
    fig.tight_layout()
    fig.savefig(os.path.join(PLOT_PATH,'R0R1.pdf'),dpi=resolve)
    plt.close('all')
    #####
    #####
