...
dbOutputPath = joinpath("emergence-quadratic-roots_output.sqlite") # cluster
...
# dbOutputPath = joinpath("/Volumes/Yadgah/crispr-sweep-7-2-2022/isolates/runID3297-c66-r47/emergence-quadratic-roots_output.sqlite") # local
if isfile(dbOutputPath)
    error("emergence-quadratic-roots_output.sqlite already exists; delete first")
end
##
